...
app.config(bg="black")
photo1 = ImageTk.PhotoImage(Image.open("/Users/ivan/PycharmProjects/pythonProject/music/soptify/play.png").resize((60, 60), Image.ANTIALIAS))
photo2 = ImageTk.PhotoImage(Image.open("/Users/ivan/PycharmProjects/pythonProject/music/soptify/pause.png").resize((60, 60), Image.ANTIALIAS))
photo3= ImageTk.PhotoImage(Image.open("/Users/ivan/PycharmProjects/pythonProject/music/soptify/Spotify.png").resize((300, 100), Image.ANTIALIAS))
print('tkinter boot finished')
directory = askdirectory(initialdir='/Users/ivan/Desktop/all/music')
os.chdir(directory)
songList = os.listdir()
